...
<head>
    ...
    <link rel="stylesheet" href="css_H/reset.css">
    <link rel="stylesheet" href="../components/component_mobile.css">
    <link rel="stylesheet" href="css_H/Filed-guide.css">
</head>
<body>
    <!------ topNav 要跟menu一起複製------>
    </div>
    <div class="topNav_mobile">
        <a class="logo" href="#">
            <img class='mb' src="./img_H/logo-1.svg" alt="">
            <img class='pc' src="./img_H/logo-2.svg" alt="">
        </a>
        <div class="icon_wrap">
            <div class="sec1">
                <a href="">
                    <img src="./img_H/Cart.svg" alt="">
                </a>
                <a id="memberPic" href="">
