        ...
        <div class="mobile-backpage">
            <svg width="40" height="23" viewBox="0 0 40 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M17.8787 0.87868C19.0503 -0.292893 20.9497 -0.292893 22.1213 0.87868L39.1213 17.8787C40.2929 19.0503 40.2929 20.9497 39.1213 22.1213C37.9497 23.2929 36.0502 23.2929 34.8787 22.1213L20 7.24264L5.12132 22.1213C3.94975 23.2929 2.05025 23.2929 0.87868 22.1213C-0.292893 20.9497 -0.292893 19.0503 0.87868 17.8787L17.8787 0.87868Z"
                    fill="#FFFFFF" />
            </svg>
            <a href="#">套裝活動報名</a>
        </div>
            ...
            <div class="enroll-detail-card col-md-5">
                <div class="card-deco">
                    ...
                    <div class="payable row">
                        ...
                        <div class="col total-price">0</div>
                    </div>
                        ...
                        <!-- <div class="enroll-content-form">
                                ...
                                <div class="enroll-other">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="add-member-data" name="add-member-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="id-num" name="id-num[]">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <fieldset>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="inlineRadio2" name="eating-habit[]"
                                                        value="全素">
