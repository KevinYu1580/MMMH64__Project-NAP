...
$pageName = 'each_room_single'; // 頁面名稱
?>
            ...
            <div class="each-room-col col-md-6">
                <div class="room-btn-group d-flex justify-content-sm-around justify-content-md-end">
                    <div class="single-btn default d-flex">
                        <a href="./Each_Room_single.html">單人房 呼嚕嚕</a>
                    </div>
                    <div class="double-btn d-flex">
                        <a href="./Each_Room_double.html">雙人房 皺皺鼻</a>
                    </div>
                    <div class="four-btn d-flex">
                        <a href="./Each_Room_quadra.html">四人房 撓癢癢 </a>
                    </div>
                </div>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="../nap_php/img/nap-intro/roomInfo/single-room/single-06.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../nap_php/img/nap-intro/roomInfo/single-room/single-01.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../nap_php/img/nap-intro/roomInfo/single-room/single-05.jpg" class="d-block w-100" alt="...">
                            </div>
                        </div>
            ...
            <div class="each-room-col col-md-6 d-md-flex ">
                <div class="room-textbox">
                        ...
                        <div class="room-text-col col-md-6">
                            <div class="room-detail-row d-flex">
                                <div class="room-detail-col col-6">
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/File-1.svg" alt="">
                                        </div>
                                        <small>加大單人床*1</small>
                                    </div>
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/Towel.svg" alt="">
                                        </div>
                                        <small>附衛浴用品</small>
                                    </div>
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/Frige.svg" alt="">
                                        </div>
                                        <small>冰箱</small>
                                    </div>
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/Bottle.svg" alt="">
                                        </div>
                                        <small>免費瓶裝水</small>
                                    </div>
                                </div>
                                <div class="room-detail-col col-6">
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/Coffee.svg" alt="">
                                        </div>
                                        <small>含早餐乙客</small>
                                    </div>
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/Ice.svg" alt="">
                                        </div>
                                        <small>獨立空調</small>
                                    </div>
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/Hair dryer.svg" alt="">
                                        </div>
                                        <small>吹風機</small>
                                    </div>
                                    <div class="each-detail d-flex align-items-center">
                                        <div class="detail-imgbox">
                                            <img src="../nap_php/img/component/icon/Paw.svg" alt="">
                                        </div>
                                        <small>可提供寵物餐食</small>
                                    </div>
                                </div>
                    ...
                    <div class="booking-btn d-md-flex justify-content-md-end">
                        <a href="./Room_Booking.html">前往訂房</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="check-in-instructions-mobile">
    ...
    <div class="expand-btn1">
        <img src="../nap_php/img/component/icon/arrow_down.svg" alt="" class="down">
    </div>
</div>
...
<script src="../nap_php/nap_js/each_room.js"></script>
<!-- 自己的js放在這 -->
