...
// 選擇器 | filter
$('.special-switch , .events-banner-special-btn').click(spacialBtnEvent);

function spacialBtnEvent() {
	console.log('spacialBtnEvent');
	// 框換色
	$('.events-switch-frame').css(
		'borderColor',
		'var(--secondaryColor_default)'
	);
	...
	// 文字換色
	$('.card-textbox-mb h4, .card-textbox-mb h3, .card-textbox-mb h5').css(
		'color',
		'var(--secondaryColor_default)'
	);
