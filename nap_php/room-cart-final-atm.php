...
$order_sql = sprintf("INSERT INTO `room_order`( 
    ...
    `payment_deadline`, 
    `create_at`
    ) VALUES (%s, %s, $room_order_origin_price, $room_order_price,'$room_order_deposit', %s, %s, '$room_order_note', '$room_order_id', %s, %s, '$paydate', Now())", $_SESSION['user']['id'], $_SESSION['rm-coupon']['sid'], '111', '1', '1', '1');
...
INNER JOIN room_order_detail on room_order_detail.room_order_sid = room_order.sid
INNER JOIN room_detail on room_detail.sid = room_order_detail.room_sid
...
<!-- 加自己的css -->
<link rel="stylesheet" href="./nap_css/room-cart-final-step-atm.css">
                ...
                <?php foreach ($rows as $r) : ?>
                    ...
                    <div class="per-cart-item">
                        ...
                        <div class="item-list">
                            ...
                            <div class="stay-date"><?= $r['order_day1'] ?> - <?= $r['order_day2'] ?>(
                                <span class="night">
                                    <?= $r['days'] ?>
                                </span>
                                晚 )
                            ...
                            <div class="room-night">
                                ...
                                <div class="room-num">
                                    <p>x<span class="num" data-val="<?= $r['num'] ?>"></span> 間</p>
                                </div>
                                <div class="night-num">
                                    <p>x<span><?= $r['days'] ?></span> 晚</p>
                                </div>
                            </div>
