        ...
        <div class="booking-data-right col-md-5">
            ...
            <div class="booking-detail-combine">
                <div class="booking-detail-content single-detail">
                    <div class="room-name single-name">
                        <!--帶入單人房名-->
                    </div>
                    ...
                    <div class="room-detail-num">
                        ...
                        <div class="room-detail-price singlePrice">NT$ <span>
                                <!--帶入單人總價錢-->
                            </span></div>
                    </div>
                ...
                <div class="booking-detail-content double-detail">
                    <div class="room-name double-name">
                        <!--帶入雙人房名-->
                    </div>
                    <div class="room-count">
                        <div class="per-room-night">
                    ...
                    <div class="room-detail-num">
                        <div class="room-detail-text">總價</div>
                        <div class="room-detail-price doublePrice">NT$ <span>
                                <!--帶入雙人總價錢-->
                            </span></div>
                    </div>
                    <div class="price-include">
                ...
                <div class="booking-detail-content quadra-detail">
                    <div class="room-name quadra-name">
                        <!--帶入四人房名-->
                    </div>
                    <div class="room-count">
                        <div class="per-room-night">
                    ...
                    <div class="room-detail-num">
                        <div class="room-detail-text">總價</div>
                        <div class="room-detail-price quadraPrice">NT$ <span>
                                <!--帶入四人總價錢-->
                            </span></div>
                    </div>
                    <div class="price-include">
