...
$sql = "SELECT * FROM `event_order_detail` LEFT join event_order on event_order.sid = event_order_detail.event_sid LEFT join event_detail on event_detail.sid = event_order_detail.event_order_sid where member_sid=$member_id AND `order_status` = 1 AND `payment_way` = 1";
